...
```{r plot-cross-correlations, fig.cap = "Cross correlations between reads. The distance corresponding to the maximum height provides a good estimate of the most common fragment length. Relative heights between replicate samples also indicate the success of the immuno-precipitation."}
here::here(
